...
class JoinGroupMobile extends StatefulWidget {
  @override
  _JoinGroupMobileState createState() => _JoinGroupMobileState();
}

class _JoinGroupMobileState extends State<JoinGroupMobile> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: 292,
                    child: Text("Join the team on any\nchannel for live updates\nand win free weekly tickets\nfor a season ",
